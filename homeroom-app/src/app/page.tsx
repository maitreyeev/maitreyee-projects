...
export default function Home() {
  ...
  function goToSyllabus() {
    ...
    saveSession({ name: name.trim(), age, boardId });
            ...
            <div className="flex flex-col items-center text-center gap-6 py-10">
              ...
              <div>
                ...
                <p className="text-muted mt-3 leading-relaxed">
                  A one-click homeschool planner. Tell us your child&apos;s age
                  and board, get a curated syllabus, and pick any topic for a
                  hands-on, activity-filled lesson — free, no login.
                </p>
              </div>
